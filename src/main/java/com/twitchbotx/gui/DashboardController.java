...
public class DashboardController implements Initializable, ControlledScreen {
    ...
    TwitchBotX bot;
    Datastore store;
    public static WSClass twitchWSIRC;
    ...
    private void close(ActionEvent event) throws IOException {
        DashboardController.twitchWSIRC.send("PART #" + channelName);
    ...
    private void startBot(ActionEvent event) {
        ...
        try {
            ...
            botT = new Thread() {
                ...
                public void run() {
                    try {
                        //System.out.println("channel: " + channelName + " bot: "
                               // + botName);
                        twitchWSIRC = new WSClass(new URI("wss://irc-ws.chat.twitch.tv"), channelName,
                                botName, botPassword, guiHandler.bot.getStore());
    ...
    private void restartBot(ActionEvent event) {
        ...
        DashboardController.twitchWSIRC.close();
    }
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        visitCount++;
        botName = store.getConfiguration().account;
        channelName = store.getConfiguration().joinedChannel;
        botPassword = store.getConfiguration().password;
    }
