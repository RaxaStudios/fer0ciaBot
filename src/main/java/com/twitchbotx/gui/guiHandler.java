...
import static com.twitchbotx.gui.DashboardController.twitchWSIRC;
...
public class guiHandler extends Application {
    ...
    public static LotteryController lotto;
   ...
   // public Socket socket;
    ...
    public void start(Stage primaryStage) {
        ...
        try {
            ...
            Path xmlResolved = xmlFile.resolve("fbot.xml");
            ...
            lotto = new LotteryController();
            
            // open up Websocket instance
        } catch (Exception e){
            e.printStackTrace();
        }
        //create and show GUI
        ...
        stage.setTitle("Fer0cia Bot 1.0");
