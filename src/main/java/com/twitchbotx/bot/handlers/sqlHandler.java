...
public class sqlHandler {
    ...
    public sqlHandler(final Datastore store) {
        this.store = store;
        this.SQLURL = guiHandler.bot.getStore().getConfiguration().sqlURL;
        this.USER = guiHandler.bot.getStore().getConfiguration().sqlUser;
        this.PASS = guiHandler.bot.getStore().getConfiguration().sqlPass;
        this.gameID = "";
        this.gameName = "";
        this.gamePoints = "";
    }
    ...
    public void setName(String msg) {
        ...
        DashboardController.twitchWSIRC.sendMessage("Renamed " + oldName + " to " + newName);
        closeConnection();
    }
    ...
    public void setPoints(String msg) {
        ...
        DashboardController.twitchWSIRC.sendMessage("Set " + game + " to " + newPoints);
        closeConnection();
    }
    ...
    ** get methods for points, name, id
    ...
    public void addPoints(String msg) {
        String enabled = "on"; 
                //this.store.getConfiguration().sStatus;
        ...
        if (enabled.equals("on")) {
            ...
            try {
                ...
                DashboardController.twitchWSIRC.sendMessage(points + " added to " + game);
                sendEvent(game, points);
                closeConnection();
            } catch (IllegalArgumentException il) {
                DashboardController.twitchWSIRC.sendMessage("Syntax: !s-addPoints [gameID] [points]");
            } catch (SQLException sql) {
                DashboardController.twitchWSIRC.sendMessage("Syntax: !s-addPoints [gameID] [points]");
                LOGGER.severe(sql.toString());
            }
    ...
    public void getPoints(String msg, String username) {
        ...
        try {
            ...
            DashboardController.twitchWSIRC.sendMessage(wording + " " + sb);
            closeConnection();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void gameSearch(String msg, int points) {
        if (msg.contains("#")) {
            ...
            try {
                ...
                if (gameCount > 1) {
                    DashboardController.twitchWSIRC.sendMessage("Multiple games found in message");
                } else {
                    ...
                    try {
                        ...
                        DashboardController.twitchWSIRC.sendMessage(points + " added to " + tGame);
                        closeConnection();
                    } catch (IllegalArgumentException il) {
    ...
    ** quick method to disable system for user side
    ...
    public void sStatus(String msg) {
        ...
        if (status.equals("on") || status.equals("off")) {
            ...
            DashboardController.twitchWSIRC.sendMessage("Spoopathon system set to " + status);
        } else {
            DashboardController.twitchWSIRC.sendMessage("Syntax: !s-status [on|off]");
        }
